        ...
        <div>
            ...
            <div className="card card-side bg-base-100 shadow-xl mx-6">
                ...
                <div className="card-body">
                    ...
                    <p className='p-5 text-orange-300'>mouth and with the hands. We use many words to describe food texture—foods can be soft or hard, mushy or crunchy, or smooth or lumpy. Texture is important is heaer the enjoyment and other then acceptability of foods.</p>
