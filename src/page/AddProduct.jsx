...
const AddProduct = () => {
    const handleAddProduct = (e) => {
        ...
        const brand_name = form.brand_nmae.value;
        const rating = form.rating.value;
        const category = form.category.value;
        const description = form.description.value;
        const photo = form.photo.value;

        const newProduct = { name, price, brand_name, rating, category, description, photo }
    ...
    return (
        <div className="bg-[#F4F3F0] p-24 mx-52">
            ...
            <form onSubmit={handleAddProduct}>
                ...
                <input type="submit" value="Add Product" className="btn text-white w-full bg-gray-800" />
